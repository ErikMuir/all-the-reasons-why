const reasons = {
  ...
  aunt: [
    ...
    "You're the cool aunt who teases like an older sibling, but also gives it straight when no one else will",
  ],
  singer: [
  ...
  friend: [
    ...
    "You regularly practice kindness, patience, and understanding with your friends",
    "You are reliable and consistent",
  ],
  teacher: [
    "You not only have the willingness to be a teacher, you also possess a heart for the children",
  ...
  person: [
    ...
    "You value hard work, patience, loyalty, and fair play (just like a good little Hufflepuff should)",
  ],
  lover: [
